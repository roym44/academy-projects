...
public class BigramModelTester {
	public static final String ALL_YOU_NEED_FILENAME = "../resources/all_you_need.txt";
	public static final String EMMA_FILENAME = "../resources/emma.txt";
	public static final String ALL_YOU_NEED_MODEL_DIR = "../resources/all_you_need_model";
